...
//		}
	...
	public ResponseEntity<Object> getReminderDetailById(@PathVariable("reminderId") int id) throws ReminderNotExistsException{
		Reminder reminder=service.getReminder(id);
		if(reminder!=null) {
			return new ResponseEntity<Object>("reminder",HttpStatus.OK);
		}
	...
	public ResponseEntity<?> addReminderDetails(@RequestBody Reminder reminder){
		Reminder addReminder=service.addReminder(reminder);
		if(addReminder!=null) {
	...
	public ResponseEntity<?> updateReminder(@RequestBody Reminder reminder, @PathVariable int reminderId)
			throws ReminderNotExistsException {
		if (service.updateReminder(reminder) != null) {
	...
	public ResponseEntity<Object> deleteReminderDetails(@PathVariable int reminderId) throws ReminderNotExistsException{
		service.deleteReminder(reminderId);
		if(service.getReminder(reminderId)==null) {
