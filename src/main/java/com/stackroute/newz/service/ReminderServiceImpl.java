...
public class ReminderServiceImpl implements ReminderService {
	...
	public Reminder addReminder(Reminder reminder) {
		Reminder rem=repository.save(reminder);
		if(rem!=null) {
			return rem;
		}
		return null;
	...
	public Reminder updateReminder(Reminder reminder) throws ReminderNotExistsException {
		if(repository.getOne(reminder.getReminderId())!=null) {
	...
	public void deleteReminder(int reminderId) throws ReminderNotExistsException {
		if(repository.getOne(reminderId)!=null) {
	...
	public Reminder getReminder(int reminderId) throws ReminderNotExistsException {
		Optional<Reminder> rem=repository.findById(reminderId);
		if(rem.isPresent()) {
			return rem.get();
		}else {
			throw new ReminderNotExistsException();
	...
	public List<Reminder> getAllReminders() {
		List<Reminder> listRem=repository.findAll();
		return listRem;
	}
